...
##
##  updated april 13, 2017 to include road selection by attribute for huc
##  160203 to match the selection in place for the same huc in the script for
##  the NW region.
##
...
##  define hucs
hucs = "Y:\\TIGER\\reg_sw\\sw_huc6rng_gap.shp"
##  define roads
rds = "Y:\\TIGER\\reg_sw\\roads.gdb\\sw_roads"
##  define scratch space
scratch = "Y:\\TIGER\\reg_sw\\scratch"
##  define results output directory
output = "Y:\\TIGER\\reg_sw\\intDens"
...
for huc in hucIDs:
    try:
        ...
        if huc == "140100":
            arcpy.SelectLayerByAttribute_management("rdsLayer","REMOVE_FROM_SELECTION",'LOWER("FULLNAME")  LIKE \'%usfs%\'')

        if huc == "140802":
            arcpy.SelectLayerByAttribute_management("rdsLayer","REMOVE_FROM_SELECTION",'LOWER("FULLNAME")  LIKE \'%forest rd%\' OR LOWER("FULLNAME")  LIKE \'%fs rd%\' OR LOWER("FULLNAME")  LIKE \'%indian %\' OR LOWER("FULLNAME")  LIKE \'%logging%\' OR LOWER("FULLNAME")  LIKE \'%navajo svc%\' OR LOWER("FULLNAME")  LIKE \'%pr-rd%\' OR LOWER("FULLNAME")  LIKE \'%prt-rd%\' OR LOWER("FULLNAME")  LIKE \'%prvt-rd%\' OR LOWER("FULLNAME")  LIKE \'%pvt%\' OR LOWER("FULLNAME")  LIKE \'%un%\'')

        if huc == "150301":
            arcpy.MakeFeatureLayer_management("Y:\\TIGER\\reg_sw\\150301_rdsManuallyRemoved.shp","removeLayer")
            ...
            arcpy.SelectLayerByAttribute_management("rdsLayer","REMOVE_FROM_SELECTION",'LOWER("FULLNAME")  LIKE \'%unknown%\' OR LOWER("FULLNAME")  LIKE \'%unnamed%\'')

        if huc == "150200":
            arcpy.SelectLayerByAttribute_management("rdsLayer","REMOVE_FROM_SELECTION",'LOWER("FULLNAME")  LIKE \'%forest svc%\' OR LOWER("FULLNAME")  LIKE \'%forest rd%\' OR LOWER("FULLNAME")  LIKE \'%forest rte%\' OR LOWER("FULLNAME")  LIKE \'%forest svc%\' OR LOWER("FULLNAME")  LIKE \'%fr %\' OR LOWER("FULLNAME")  LIKE \'fs %\' OR LOWER("FULLNAME")  LIKE \'%indian rte%\' OR LOWER("FULLNAME")  LIKE \'%indian svc%\' OR LOWER("FULLNAME")  LIKE \'%indsr%\' OR LOWER("FULLNAME")  LIKE \'%navajo%\' OR LOWER("FULLNAME")  LIKE \'%pr dr%\' OR LOWER("FULLNAME")  LIKE \'%pvt%\' OR LOWER("FULLNAME")  LIKE \'%ub named%\' OR LOWER("FULLNAME")  LIKE \'%unknown%\' OR LOWER("FULLNAME")  LIKE \'%un-named%\' OR LOWER("FULLNAME")  LIKE \'%un_named%\' OR LOWER("FULLNAME")  LIKE \'%un-rd%\' OR LOWER("FULLNAME")  LIKE \'%un knw rd%\' OR LOWER("FULLNAME")  LIKE \'%un name rd%\' OR LOWER("FULLNAME")  LIKE \'%un %\' OR LOWER("FULLNAME")  LIKE \'%uname rd%\' OR LOWER("FULLNAME")  LIKE \'%unnamed%\' OR LOWER("FULLNAME")  LIKE \'%unamee rd%\' OR LOWER("FULLNAME")  LIKE \'%unname%\' OR LOWER("FULLNAME")  LIKE \'%unmd%\' OR LOWER("FULLNAME")  LIKE \'%usfs%\'')

        if huc == "150503":
            arcpy.SelectLayerByAttribute_management("rdsLayer","REMOVE_FROM_SELECTION",'LOWER("FULLNAME") LIKE \'%indian rte%\'')

        if huc == "130202":
            arcpy.MakeFeatureLayer_management("Y:\\TIGER\\reg_sw\\130202_rdsManuallyRemoved.shp","removeLayer")
            arcpy.SelectLayerByLocation_management("rdsLayer","ARE_IDENTICAL_TO","removeLayer","","REMOVE_FROM_SELECTION")
            arcpy.Delete_management("removeLayer")
            arcpy.SelectLayerByAttribute_management("rdsLayer","REMOVE_FROM_SELECTION",'LOWER("FULLNAME")  LIKE \'%forest rd%\' OR LOWER("FULLNAME")  LIKE \'%forest service%\' OR LOWER("FULLNAME")  LIKE \'%forest svc%\' OR LOWER("FULLNAME")  LIKE \'fs %\' OR LOWER("FULLNAME")  LIKE \'fs %\' OR LOWER("FULLNAME")  LIKE \'%indian svc%\' OR LOWER("FULLNAME")  LIKE \'%indsr%\' OR LOWER("FULLNAME")  LIKE \'%unnamed%\' OR LOWER("FULLNAME")  LIKE \'%unknown%\' OR LOWER("FULLNAME")  LIKE \'%unk %\' OR LOWER("FULLNAME")  LIKE \'%unname%\' OR LOWER("FULLNAME")  LIKE \'%wsmr%\'')

        if huc == "130600":
            arcpy.SelectLayerByAttribute_management("rdsLayer","REMOVE_FROM_SELECTION",'LOWER("FULLNAME")  LIKE \'%forest rd%\' OR LOWER("FULLNAME")  LIKE \'%pvt%\' OR LOWER("FULLNAME")  LIKE \'fs %\' OR LOWER("FULLNAME")  LIKE \'%indian svc%\'')

        if huc == "130500":
            arcpy.SelectLayerByAttribute_management("rdsLayer","REMOVE_FROM_SELECTION",'LOWER("FULLNAME")  LIKE \'%4x4%\' OR LOWER("FULLNAME")  LIKE \'%forest rd%\' OR LOWER("FULLNAME")  LIKE \'%forest service%\' OR LOWER("FULLNAME")  LIKE \'%forest svc%\' OR LOWER("FULLNAME")  LIKE \'fs %\' OR LOWER("FULLNAME")  LIKE \'%indian svc%\' OR LOWER("FULLNAME")  LIKE \'%pvt%\' OR LOWER("FULLNAME")  LIKE \'%unkn%\' OR LOWER("FULLNAME")  LIKE \'%wsmr%\'')
...
arcpy.FeatureToRaster_conversion("P:\\Proj3\\USGap\\Vert\\Model\\data\\regions\\regclip_sw.shp","FID","Y:\\TIGER\\reg_sw\\sw_bnd","30")

##  move workspace to directory with line density outputs
arcpy.env.workspace = scratch

##  set extent and mask to buffered region boundary grid
arcpy.env.mask = "Y:\\Avoid\\maskbuf_sw"
arcpy.env.extent = "Y:\\Avoid\\maskbuf_sw"
...
arcpy.gp.cellstatistics_sa(nulls,"Y:\\TIGER\\reg_sw\\mosaic\\sw_rddens","MAXIMUM")
