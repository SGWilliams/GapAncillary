...
##
##    Written in python 2.5, executed in python 2.7 through ESRI's software ArcMap 10.4.1
##
##
##    This script was written to produce an avoidance mask used in modeling predicted habitat
##    for target vertabrate species.  This script is the second stage of a two-stage process.
##    In the first stage, a counterpart script is run to produce a road density raster, which
##    is used in this script.  Due to regional variation in processes used to create US Census
##    Bureau TIGER Roads data, a separate script was written for each region of the CONUS.
##
##    gp_roadDensity.py
##    ne_roadDensity.py
##    nwgp_roadDensity.py
...
##
##        a.  Identifies groups of 5 cells or more in National Land Cover Dataset values:
##            22 (Developed, Low Intensity)
##            23 (Developed, Medium Intensity)
##            24 (Developed, High Intensity)
##            and expands (buffers) them 120 meters (using the Euclidean Distance tool).
...
##            region is:
##                1.  greater than or equal to 25 meters per 10,000 square meters
##                2.  greater than or equal to 65 meters per 10,000 square meters
##                3.  greater than or equal to 130 meters per 10,000 square meters
...
##
##
##    Updated April, 2017: buffered masks of US regions were employed to allow for neighborhood analysis
##    to uniformly be performed across the boundaries of regions.  Mask and extent are set to actual regional
##    boundary just prior to final step.
##
####################################################################################################################################
...
for region in regions:
    ...
    try:
        ...
        arcpy.env.extent = "Y:\\Avoid\\maskbuf_" + region
        arcpy.env.mask = "Y:\\Avoid\\maskbuf_" + region
